...
// ✅ SOLUCIÓN: El componente se declara AQUÍ FUERA, antes del export
const MyFooter = () => (
  <footer className="w-full py-6 mt-auto border-t border-slate-800 bg-slate-900/50 text-center">
    <p className="text-slate-500 text-xs sm:text-sm font-medium">
      Todos los derechos reservados &copy; {new Date().getFullYear()} | 
      <span className="text-blue-500 font-bold"> Antonio Baena Moreno </span> | 
      <a href="https://www.tonidev71.com" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">
        www.tonidev71.com
      </a>
    </p>
  </footer>
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans flex flex-col">
      ...
      <div className="flex-grow">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-8 pt-8">
          ...
          <main className="md:col-span-6 pb-10">
